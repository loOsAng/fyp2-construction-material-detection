...
| **Training** | Single-stage / two-stage / balanced oversampling; supports YOLOv8/YOLO11/YOLO26 checkpoints |
...
│
├── best.pt                 Default weights (138 MB)
└── bestModelSelect/        9 trained checkpoints (2.8 GB)
```
...
| **训练** | 单阶段 / 两阶段 / 类别平衡过采样；兼容 YOLOv8/YOLO11/YOLO26 |
...
│
├── best.pt                 默认权重 (138 MB)
└── bestModelSelect/        9 个训练好的模型 (2.8 GB)
```
